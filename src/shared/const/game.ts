...
export const CONTROLLED_ZONE_HEIGHT = 37 * GRID_SIZE // 370px
...
export const TORPOR_ZONE_BOTTOM = TORPOR_ZONE_Y + TORPOR_ZONE_HEIGHT // 520px
export const CARD_STACKS_Y = TORPOR_ZONE_BOTTOM + GRID_SIZE // 530px
