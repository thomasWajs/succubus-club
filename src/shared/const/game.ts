...
export const ACTION_DECLARATION_OUTLINE_COLOR = 'rgb(70,150,255)'
...
export const CONTROLLED_ZONE_HEIGHT = 39 * GRID_SIZE // 370px
export const TORPOR_ZONE_HEIGHT = 10 * GRID_SIZE // 100px
export const TORPOR_ZONE_Y = PLAYER_BAR_HEIGHT + CONTROLLED_ZONE_HEIGHT // 400px
export const TORPOR_ZONE_BOTTOM = TORPOR_ZONE_Y + TORPOR_ZONE_HEIGHT // 500px
export const CARD_STACKS_Y = TORPOR_ZONE_BOTTOM + GRID_SIZE // 510px
export const CARD_STACKS_HEIGHT = CARD_IN_STACK_SCALE * CARD_WIDTH + 10 // 64px
export const PLAY_AREA_HEIGHT = CARD_STACKS_Y + CARD_STACKS_HEIGHT // 574px
export const UNCONTROLLED_WIDTH = GRID_SIZE * 8 * 4 - GRID_SIZE // 310px
